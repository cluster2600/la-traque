# THOMAS DIEUDEGARD'S OPERATIONAL TEAM
## DGSE Special Operations Unit — Tadrart Insertion
...
### Professionalism:
- All authorized DGSE operators
- All speak minimum 2-3 languages
...
- To success (no failures acceptable)
...
### Known each other:
- Average 5+ years together
- Previous operations: 3-5 successful missions
- Trust established
...
- No ego conflicts
- Clear hierarchy accepted
- Role clarity understood
